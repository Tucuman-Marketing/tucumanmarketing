<div style="display: none;" class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel" >
    ...
    <div class="offcanvas-body">
        ...
        <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row switcher-style gx-0  gy-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check switch-select">
                                ...
                                <input class="form-check-input" type="radio" name="sidemenu-layout-styles"
                                    id="switcher-icontext-menu" checked>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-check switch-select">
                    ...
                    <div class="row switcher-style gx-0">
                        ...
                        <div class="col-4">
                            <div class="form-check switch-select">
                                ...
                                <input class="form-check-input" type="radio" name="menu-positions" id="switcher-menu-scroll" checked>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row switcher-style gx-0">
                        ...
                        <div class="col-4">
                            <div class="form-check switch-select">
                                ...
                                <input class="form-check-input" type="radio" name="header-positions"
                                    id="switcher-header-scroll" checked>
                            </div>
                        </div>
            ...
            <div class="d-flex justify-content-between canvas-footer flex-wrap">
                <a target="_blank" href="https://themeforest.net/item/velvet-codeigniter-bootstrap-admin-dashboard-template/51391302" class="btn btn-primary">Buy Now</a>
