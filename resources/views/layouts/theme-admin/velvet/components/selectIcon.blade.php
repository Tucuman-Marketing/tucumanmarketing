...
<!-- Modal para seleccionar el ícono -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Campo de búsqueda -->
                <div class="mb-3">
                    <input type="text" id="iconSearch" class="form-control" placeholder="Buscar ícono...">
                </div>
                <!-- Contenedor de íconos -->
                <div id="iconList" class="d-flex flex-wrap">
...
@parent
    <script>
        function openIconModal() {
            ...
            // Asegura que el backdrop del modal principal no se oculte cuando se abra el modal secundario
            $('#iconModal').on('show.bs.modal', function () {
                var $backdrop = $('.modal-backdrop').last();
                var zIndex = parseInt($backdrop.css('z-index')) + 10;
                $backdrop.css('z-index', zIndex);
                $(this).css('z-index', zIndex + 10);
            });

            // Restaura los valores de z-index cuando se cierra el modal secundario
            ...
            // Evita que el modal principal se cierre al abrir el secundario
            ...
            function renderIcons(filter = '') {
                ...
                filteredIcons.forEach(icon => {
                    $('#iconList').append(`<i class="bi ${icon} icon-selectable" style="font-size: 24px; cursor: pointer; margin: 5px;"></i>`);
                });
            }
            ...
            $(document).on('click', '.icon-selectable', function() {
                const selectedIcon = $(this).attr('class').split(' ')[1];
                $('#selectedIcon').val(selectedIcon);
                $('.icon').empty();
                $('.icon').val(selectedIcon); // Coloca el valor del ícono en el input name
