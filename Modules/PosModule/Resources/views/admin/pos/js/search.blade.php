   ...
   function Filtrar() {
      ...
      //  }
       var parametrosBusqueda = {
           ...
           search_dni: $("#search_dni").val() || null,
           search_plate: $("#search_plate").val() || null,
       ...
       table.ajax.url('{{ route("admin.washeds.searchDatatable") }}?' + $.param(parametrosBusqueda)).load();
   }
   
   function Filtrarlimpiar() {
       //Limpiar todos los campos de búsqueda
       $("#search_client").val(null).trigger('change');
       $("#search_dni").val(null).trigger('change');
       $("#search_plate").val(null).trigger('change');
