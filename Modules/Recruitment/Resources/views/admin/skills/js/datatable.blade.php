<script>
    var tableName = 'recruitment_skills_table';
    var ajaxMethod = 'GET';
    //Permisos
    var permissions = {
        canDelete: @permission('recruitment-skills-delete') true @else false @endcan,
        canEdit: @permission('recruitment-skills-edit') true @else false @endcan,
        canShow: @permission('recruitment-skills-view') true @else false @endcan,
    };
    //Urls
    var urls = {
        baseUrl: "{{ asset('') }}",
        baseUrlShow: "{{ route('admin.recruitment.skills.show', ['object' => 'tempId']) }}",
        baseUrlEdit: "{{ route('admin.recruitment.skills.edit', ['object' => 'tempId']) }}",
        baseUrlDelete: "{{ route('admin.recruitment.skills.destroy', ['object' => 'tempId']) }}",
        baseUrlMassDelete: "{{ route('admin.recruitment.skills.massDestroy') }}",
        indexUrl: "{{ route('admin.recruitment.skills.indexDatatable') }}"
    };
    //Ordenamiento
    var order = [
        [3, 'desc']
