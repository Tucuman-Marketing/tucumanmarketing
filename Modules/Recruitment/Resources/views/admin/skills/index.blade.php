...
<div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
    <h4 class="fw-medium mb-0">Trabajos / Skills</h4>
    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- BUSCADOR --}}
                @include('recruitment::admin.skills.forms.search')
                {{-- BUSCADOR --}}
    ...
    <!--modal create-->
    @include('recruitment::admin.skills.modal.create')
    <!--modal show-->
    @include('recruitment::admin.skills.modal.show')
    <!--modal edit-->
    @include('recruitment::admin.skills.modal.edit')
...
@section('other-scripts')
    {{-- DATATABLE --}}
    @include('recruitment::admin.skills.js.datatable')
@stop
