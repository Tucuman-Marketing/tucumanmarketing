<div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="exampleModalXlLabel"  aria-hidden="true">
 <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.recruitment.candidatesStatus.store')}}" method="POST" enctype="multipart/form-data" >
            @csrf

                <div class="modal-body">
                    @include('recruitment::admin.candidatesStatus.forms.create')
                </div>
