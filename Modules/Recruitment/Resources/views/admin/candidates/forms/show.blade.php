            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese el nombre" id="name" name="name"
                        value="{{ $data->name }}" required disabled>
                </div>
            </div>
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese el apellido" id="last_name"
                        name="last_name" value="{{ $data->last_name }}" required disabled>
                </div>
            </div>
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese el teléfono" id="phone" name="phone"
                        value="{{ $data->phone }}" required disabled>
                </div>
            </div>
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="education_level_1" id="education_level_1" required disabled>
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="education_state_1" id="education_state_1" required disabled>
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-graduation-cap"></i></span>
                    <span class="input-group-text">Nivel máximo de estudios</span>
                    <select class="form-control" name="education_level_2" id="education_level_2" required disabled>
                        @foreach(config('form.select.education_levels') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{ $label }}
                        </option>
                        @endforeach
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-graduation-cap"></i></span>
                    <span class="input-group-text">Estado actual de estudio</span>
                    <select class="form-control" name="education_state_2" id="education_state_2" required disabled>
                        @foreach(config('form.select.education_status') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{ $label }}
                        </option>
                        @endforeach
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-graduation-cap"></i></span>
                    <span class="input-group-text">Nivel máximo de estudios</span>
                    <select class="form-control" name="education_level_3" id="education_level_3" required disabled>
                        @foreach(config('form.select.education_levels') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{ $label }}
                        </option>
                        @endforeach
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-graduation-cap"></i></span>
                    <span class="input-group-text">Estado actual de estudio</span>
                    <select class="form-control" name="education_state_3" id="education_state_3" required disabled>
                        @foreach(config('form.select.education_status') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{ $label }}
                        </option>
                        @endforeach
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_1" id="language_1" required disabled>
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_level_1" id="language_level_1" required disabled>
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_2" id="language_2" required disabled>
                        @foreach(config('form.select.languages') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{
                            $label }}</option>
                        @endforeach
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_level_2" id="language_level_2" required disabled>
                        @foreach(config('form.select.language_levels') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{
                            $label }}</option>
                        @endforeach
        ...
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_3" id="language_3" required disabled>
                        @foreach(config('form.select.languages') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{
                            $label }}</option>
                        @endforeach
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="language_level_3" id="language_level_3" required disabled>
                        @foreach(config('form.select.language_levels') as $value => $label)
                        <option value="{{ $value }}" {{ old('education_level')==$value ? 'selected' : '' }}>{{
                            $label }}</option>
                        @endforeach
    ...
    <div class="card-body">
        <div class="row d-flex mt-3">
            ...
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                ...
                <input type="text" id="linkedin" name="linkedin" class="form-control" placeholder="LinkedIn" disabled>
            </div>

            <!-- Otra Red Social 1 -->
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                <label for="social_1" class="form-label">Otra Red Social</label>
                <input type="text" id="social_1" name="social_1" class="form-control" placeholder="Otra Red Social" disabled>
            </div>

            <!-- Otra Red Social 2 -->
            <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                <label for="social_2" class="form-label">Otra Red Social</label>
                <input type="text" id="social_2" name="social_2" class="form-control" placeholder="Otra Red Social" disabled>
            </div>
