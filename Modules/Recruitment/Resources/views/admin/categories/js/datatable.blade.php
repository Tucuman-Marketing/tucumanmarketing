<script>
    var tableName = 'recruitment_categories_table';
    var ajaxMethod = 'GET';
    //Permisos
    var permissions = {
        canDelete: @permission('recruitment-categories-delete') true @else false @endcan,
        canEdit: @permission('recruitment-categories-edit') true @else false @endcan,
        canShow: @permission('recruitment-categories-view') true @else false @endcan,
    };
    //Urls
    var urls = {
        baseUrl: "{{ asset('') }}",
        baseUrlShow: "{{ route('admin.recruitment.categories.show', ['object' => 'tempId']) }}",
        baseUrlEdit: "{{ route('admin.recruitment.categories.edit', ['object' => 'tempId']) }}",
        baseUrlDelete: "{{ route('admin.recruitment.categories.destroy', ['object' => 'tempId']) }}",
        baseUrlMassDelete: "{{ route('admin.recruitment.categories.massDestroy') }}",
        indexUrl: "{{ route('admin.recruitment.categories.indexDatatable') }}"
    };
    //Ordenamiento
    var order = [
        [3, 'desc']
