...
<div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
    <h4 class="fw-medium mb-0">Trabajos / Categorías</h4>
    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- BUSCADOR --}}
                @include('recruitment::admin.categories.forms.search')
                {{-- BUSCADOR --}}
    ...
    <!--modal create-->
    @include('recruitment::admin.categories.modal.create')
    <!--modal show-->
    @include('recruitment::admin.categories.modal.show')
    <!--modal edit-->
    @include('recruitment::admin.categories.modal.edit')
...
@section('other-scripts')
    {{-- DATATABLE --}}
    @include('recruitment::admin.categories.js.datatable')
@stop
