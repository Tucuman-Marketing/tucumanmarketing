...
<div id="input_hidden">
    <input type="hidden" id="selectedIcon" name="icon" value="{{ $data->icon }}">
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="text" class="form-control icon" placeholder="Tu icono aquí" aria-label="Icono" name="icon" value="{{ $data->icon }}">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group has-validation">
                    <input type="number" class="form-control" name="sort_order" id="sort_order" min="1" value="{{ $data->sort_order }}">
                </div>
            </div>
        </div>
                ...
                <div style="display: flex; flex-wrap: wrap;">
                    @foreach(\Modules\Blog\Entities\BlogStatus::COLOR_CATALOG as $colorName => $hexValue)
                        <div class="form-check" style="margin-right: 10px; display: flex; align-items: center;">
                            <input class="form-check-input" type="radio" name="color" id="color_{{ $colorName }}" value="{{ $hexValue }}" {{ $data->color == $hexValue ? 'checked' : '' }}>
