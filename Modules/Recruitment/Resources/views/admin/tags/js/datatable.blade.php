<script>
    var tableName = 'recruitment_tags_table';
    var ajaxMethod = 'GET';
    //Permisos
    var permissions = {
        canDelete: @permission('recruitment-tags-delete') true @else false @endcan,
        canEdit: @permission('recruitment-tags-edit') true @else false @endcan,
        canShow: @permission('recruitment-tags-view') true @else false @endcan,
    };
    //Urls
    var urls = {
        baseUrl: "{{ asset('') }}",
        baseUrlShow: "{{ route('admin.recruitment.tags.show', ['object' => 'tempId']) }}",
        baseUrlEdit: "{{ route('admin.recruitment.tags.edit', ['object' => 'tempId']) }}",
        baseUrlDelete: "{{ route('admin.recruitment.tags.destroy', ['object' => 'tempId']) }}",
        baseUrlMassDelete: "{{ route('admin.recruitment.tags.massDestroy') }}",
        indexUrl: "{{ route('admin.recruitment.tags.indexDatatable') }}"
    };
    //Ordenamiento
    var order = [
        [3, 'desc']
