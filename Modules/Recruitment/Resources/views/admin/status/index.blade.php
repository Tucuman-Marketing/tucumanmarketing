...
<div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
    <h4 class="fw-medium mb-0">Trabajos / Estatus</h4>
    <ol class="breadcrumb">
...
<div class="row">
    ...
    <!--modal create-->
    @include('recruitment::admin.status.modal.create')
    <!--modal show-->
    @include('recruitment::admin.status.modal.show')
    <!--modal edit-->
    @include('recruitment::admin.status.modal.edit')
...
@section('other-scripts')
    {{-- DATATABLE --}}
    @include('recruitment::admin.status.js.datatable')
@stop
