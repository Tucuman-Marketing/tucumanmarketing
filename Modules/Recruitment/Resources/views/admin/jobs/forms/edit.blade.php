            ...
            <div class="row d-flex mt-3">
                ...
                <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-12">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username"
                            aria-describedby="basic-addon1" id="title" name="title" value="{{ $data->title }}" required>
                    </div>
                </div>
                ...
                <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="input-group">
                        ...
                        <select class="form-control select-2" name="tags[]" id="tags" multiple>
                            @foreach ($tags as $tag)
                ...
                <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="input-group">
                        ...
                        <select class="form-control select-2" name="work_type" id="work_type">
                            <option value="">--Selecciona--</option>
                ...
                <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="input-group">
                        ...
                        <select class="form-control select-2" name="work_mode" id="work_mode">
                            <option value="">--Selecciona--</option>
                ...
                <div class="mt-3 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-12">
                    <div class="input-group">
                        ...
                        <select class="form-control select-2" name="country" id="country">
    ...
    <div class="card-body">
        <div class="row d-flex mt-3">
            <div class="form-group">
                <textarea class="form-control ckeditor" id="description" name="description">{!! $data->description !!}</textarea>
            </div>
        </div>
    </div>
</div>
