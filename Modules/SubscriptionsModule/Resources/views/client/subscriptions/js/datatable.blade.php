...
var table;
var baseUrl             = "{{ asset('') }}";
var baseUrlShow         = "{{ route('client.subscriptions.show', ['subscriptions' => 'tempId']) }}";
var baseUrlEdit         = "{{ route('client.subscriptions.edit', ['subscriptions' => 'tempId']) }}";
var baseUrlDelete       = "{{ route('client.subscriptions.destroy', ['subscriptions' => 'tempId']) }}";
...
function activartabla() {
    ...
    table = $('#datatable').DataTable({
        ...
        /*============================AJAX============================*/
        ajax: "{{ route('client.subscriptions.indexDatatable') }}",
        /*============================AJAX============================*/
        ...
        columns: [
            ...
            //action
            {
                ...
                render: function(data, type, row) {
                    ...
                    var paymentUrl = "{{ route('client.pays.payment', ['subscriptions' => 'tempId']) }}";
                    var buttons = '';
