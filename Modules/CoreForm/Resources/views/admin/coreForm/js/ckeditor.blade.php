...
function initializeCKEditor() {
    ...
    document.querySelectorAll('.ckeditor').forEach(editorElement => {
        ...
        .create(editorElement, {
            ...
            // Configuraciones adicionales para manejar el formato
            ckfinder: {
            ...
            // Evitar que CKEditor modifique el formato del texto automáticamente
            autoParagraph: false,
            ...
            // Configuración para el manejo de estilos y clases
            allowedContent: true, // Permite todo el contenido HTML
        })
        .then(editor => {
