<script>
    ...
    var urls = {
        baseUrl: "{{ asset('') }}",
        baseUrlShow: "{{ route('admin.blogs.status.show', ['status' => 'tempId']) }}",
        baseUrlEdit: "{{ route('admin.blogs.status.edit', ['status' => 'tempId']) }}",
        baseUrlDelete: "{{ route('admin.blogs.status.destroy', ['status' => 'tempId']) }}",
        baseUrlMassDelete: "{{ route('admin.blogs.status.massDestroy') }}",
        indexUrl: "{{ route('admin.blogs.status.indexDatatable') }}"
    };
    //Ordenamiento
    var order = [
        [3, 'desc']
