<script>
    ...
    var urls = {
        baseUrl: "{{ asset('') }}",
        baseUrlShow: "{{ route('admin.blogs.tags.show', ['object' => 'tempId']) }}",
        baseUrlEdit: "{{ route('admin.blogs.tags.edit', ['object' => 'tempId']) }}",
        baseUrlDelete: "{{ route('admin.blogs.tags.destroy', ['object' => 'tempId']) }}",
        baseUrlMassDelete: "{{ route('admin.blogs.tags.massDestroy') }}",
        indexUrl: "{{ route('admin.blogs.tags.indexDatatable') }}"
    };
    //Ordenamiento
    var order = [
        [3, 'desc']
