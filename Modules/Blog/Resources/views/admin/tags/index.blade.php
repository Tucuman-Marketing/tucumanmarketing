...
@section('title-module')
    <div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
        <h4 class="fw-medium mb-0">Blog / Tags</h4>
        <ol class="breadcrumb">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- BUSCADOR --}}
                @include('blog::admin.tags.forms.search')
                {{-- BUSCADOR --}}
    ...
    <!--modal create-->
    @include('blog::admin.tags.modal.create')
    <!--modal show-->
    @include('blog::admin.tags.modal.show')
    <!--modal edit-->
    @include('blog::admin.tags.modal.edit')
...
@section('other-scripts')
    {{-- DATATABLE --}}
    @include('blog::admin.tags.js.datatable')
@stop
