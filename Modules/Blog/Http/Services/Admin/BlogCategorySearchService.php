...
class BlogCategorySearchService
{
    ...
    public function buildQueryFromParameters($searchParameters)
    {
        ...
        $query = BlogCategory::distinct();
            ...
            if (!empty($searchParameters['search_date'])) {
                ...
                $query->whereDate('blog_categories.created_at', $searchDate);
            }
            ...
            if (!empty($searchParameters['search_date_range'])) {
                ...
                $query->whereBetween('blog_categories.created_at', [$searchDateRangeStart, $searchDateRangeEnd]);
            }
