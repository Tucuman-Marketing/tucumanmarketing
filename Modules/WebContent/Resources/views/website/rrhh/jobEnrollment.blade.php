        ...
        <div class="row">
            <div class="content_post col-lg-9 col-12">
                ...
                <form action="{{ route('public.jobEnrollment.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- aqui almacenamos el id del job --}}
            ...
            <div class="wrap_sidebar col-lg-3 col-12">
                <div class="sidebar p-0">
                        ...
                        <div class="lts_post">
                            <div class="min_img_w">
                                ...
                                <div class="info_m_post">
                                    <h5>{!! $item->content_short !!}</h5><span>
                                        {{ $item->published_at_readable}}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="category_widget widget">
                        ...
                        <li><a href="{{route('public.jobsByCategory', ['category' => $item->slug])}}">{{$item->name}}<i>
                                    {{ $item->jobs_count }}</i></a></li>
                        @endforeach
